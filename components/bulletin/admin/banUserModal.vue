    ...
    <v-dialog v-model="showModal" fullscreen :scrim="false" transition="dialog-bottom-transition">
        <v-card tile>
            <v-toolbar dark color="orange">
                ...
                <v-toolbar-title>Ban User</v-toolbar-title>
                <v-spacer></v-spacer>
                <v-toolbar-items>
            ...
            <div v-if="bulletin" class="container mx-auto">
                ...
                <div v-if="!submitting" @submit.prevent="submit" class="mt-5">
                    ...
                    <div v-if="userToBan" class="flex flex-col justify-center items-center absolute bottom-0 bg-red-500 z-40 w-full p-5">
                        ...
                        <button class="mt-3 underline" @click="userToBan = null">
                            Never Mind
                        </button>
                    </div>
                </div>
...
export default Vue.extend({
    ...
    methods: {
        ...
        toggleSelectUser(user: UserProfile) {
            if (this.userToBan?.id !== user.id) {
                return this.userToBan = user;
            }
            this.userToBan = null;
        },
        ...
        async submit() {
            ...
            const response = await this.banUserFromBulletin({
