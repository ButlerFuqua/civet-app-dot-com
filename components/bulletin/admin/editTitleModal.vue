        ...
        <v-card tile>
            ...
            <div class="container mx-auto">
                <form v-if="!submitting" @submit.prevent="submit" class="mt-5">
                    <v-text-field outlined dense v-model="title" aria-placeholder="title" placeholder="title" required :rules="titleRules"></v-text-field>
...
export default Vue.extend({
    ...
    data(): any {
        return {
            ...
            titleRules: [
                ...
                (title: string) => !schema.validate({ title }).error || schema.validate({ title }).error?.details[0].message,
            ],
            apiUrl: '',
            publicKey: '',
            bulletin: null,
    ...
    methods: {
        init() {
            ...
            this.title = this.bulletin?.title;
