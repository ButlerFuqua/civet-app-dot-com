    ...
    <v-app dark>
        ...
        <v-app-bar fixed app bottom v-if="!loading">
            <div class="flex justify-around">
                <button @click="toggleSelectMediaFile" class="p-1 flex" :class="mediaFile ? 'text-rose-500' : ''">
                    <CloseIcon v-if="mediaFile" />image/Video
                </button>
                <button class="p-1 text-amber-500">Post Anonymously</button>
            </div>
        </v-app-bar>
    </v-app>
</template>
